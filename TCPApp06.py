...
def DispatchCommand(commandStr, scktConn):
	...
	elif(AGNT_MAKESHOT_REQ == msgName):  return GPHOTO2_MakeshotReq(parts[1], parts[2])#DUMMY_MakeshotReq2(parts[1], parts[2])
	elif(AGNT_SENDFILE_REQ == msgName):  return DUMMY_StartTransferThread(parts[1])
